    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="jhipsterdemo01App.author.home.createOrEditLabel">
              <Translate contentKey="jhipsterdemo01App.author.home.createOrEditLabel">Create or edit a Author</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : authorEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="brithDateLabel" for="brithDate">
                    <Translate contentKey="jhipsterdemo01App.author.brithDate">Brith Date</Translate>
                  </Label>
                  <AvField id="author-brithDate" type="date" className="form-control" name="brithDate" />
                </AvGroup>
