...
export class Author extends React.Component<IAuthorProps, IAuthorState> {
  ...
  render() {
    const { authorList, match, totalItems } = this.props;
    return (
      <div>
        <h2 id="author-heading">
          <Translate contentKey="jhipsterdemo01App.author.home.title">Authors</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="jhipsterdemo01App.author.home.createLabel">Create new Author</Translate>
          </Link>
        </h2>
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('author')}>
                  <Translate contentKey="jhipsterdemo01App.author.author">Author</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('name')}>
                  <Translate contentKey="jhipsterdemo01App.author.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('brithDate')}>
                  <Translate contentKey="jhipsterdemo01App.author.brithDate">Brith Date</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {authorList.map((author, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{author.name}</td>
                  <td>
                    <TextFormat type="date" value={author.brithDate} format={APP_LOCAL_DATE_FORMAT} />
                  </td>
